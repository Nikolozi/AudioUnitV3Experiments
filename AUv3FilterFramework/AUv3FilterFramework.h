...
//! The project version number for AUv3FilterFramework_iOS.
FOUNDATION_EXPORT double AUv3FilterFramework_iOSVersionNumber;

//! The project version string for AUv3FilterFramework_iOS.
...
#import <AUv3FilterFramework/MIDIKernelAdapter.h>
